...
<!-- Nonetheless, it seems that an index of "significance", as well heuristics to interpret it are useful for Humans to gain an intuitive understanding of the interactions and structure of their data. While desire for significance assessment can be pragmatically observed in the tenacity and resilience of the *p*-value (which, despite a wide agreement on its defects and countless attacks, is still widely used and taught), its undeyling cause could be linked to the practical separation that with the the other perspective on effects description focusing on *estimation*. For instance, in some fields, the    -->

<!-- informed by the case of experimental psychology, which historically framed . Indeed, while many psychology figures also made (and still are making) great contributions to the field of statistics, the developpment of experimental psychology in particular is strongly intertwined with one particular statistical procedure, the analysis of variance (ANOVA). While being quite convenient and easy to implement (despite its not so straightforward underpinnings) and particularly suited for testing the effect of experimental conditions, the shift  -->
