...
- ***p*-direction**: the "Probability of Direction" (pd) corresponds to the probability (expressed in percentage) that an effect is strictly positive or negative (consistently with the median’s sign.
