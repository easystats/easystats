...
table2 <- rbind(
  ...
  data.frame(
    ...
    "Definition" = "???",
    "Strengths" = "???",
    "Limitations" = "A ROPE range needs to be arbitrarily defined."
    )
)
