...
# `{report}`
text_report <- report(model, verbose = FALSE)
text_report_performance <- report_performance(model, verbose = FALSE)

bracket_to_parantheses(text_report)
cat("\n")
bracket_to_parantheses(text_report_performance)
```
