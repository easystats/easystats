...
9) The "squared" term in column names that refers to "common" statistics (`Eta2`, `Chi2`, `Omega2`, ...) should be written as `2`, not `sq`, `squared` or `pétit-deux` (_example:_ `Chi2`, and _not_ `Chisq`, `Eta2`, and _not_ `Eta_squared`). This rule does _not_ apply to function names.
