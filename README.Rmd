...
dependencies <- c("insight", "performance", "bayestestR", "parameters", "correlation", "report", "estimate", "effectsize")
...
dependencies <- c(
  ...
  "correlation", "estimate", "report", "effectsize"
)
...
data <- rbind(downloads_insight,
  ...
  ungroup() %>% 
  mutate(Package = fct_relevel(Package, "insight", "bayestestR", "performance", "see", "parameters", "effectsize"))
...
blogposts$Package <- rev(c("insight", "bayestestR", "bayestestR", "performance", "bayestestR", "see", "bayestestR", "bayestestR", "performance", "parameters", "parameters", "parameters"))
...
for (package in c("insight", "bayestestR", "parameters", "performance", "effectsize", "correlation", "estimate", "report", "see")) {
