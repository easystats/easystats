...
blogposts$Package <- rev(c("insight", "bayestestR", "bayestestR", "performance", "bayestestR", "see", "bayestestR", "bayestestR", "performance", "parameters", "parameters"))
...
data %>%
  group_by(Package) %>% 
  slice(1:(n()-2)) %>%  # Remove 2 last days to avoid edge issues
  ungroup() %>%  
