...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`datawizard`](https://easystats.github.io/datawizard/)`)`` ``# for data management, e.g. recodings`\
\
[`data`](https://rdrr.io/r/utils/data.html)`(``coffee_data``, package ``=`` ``"modelbased"``)`\
\
`# dichotomize outcome variable`\
`coffee_data``$``alertness`` ``<-`` `[`categorize`](https://easystats.github.io/datawizard/reference/categorize.html)`(``coffee_data``$``alertness``, lowest ``=`` ``0``)`\
`# rename variable`\
`coffee_data`` ``<-`` `[`data_rename`](https://easystats.github.io/datawizard/reference/data_rename.html)`(``coffee_data``, select ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``treatment ``=`` ``"coffee"``)``)`
...
\
[`library`](https://rdrr.io/r/base/library.html)`(`[`report`](https://easystats.github.io/report/)`)`\
\
`# Frequency table`\
[`data_tabulate`](https://easystats.github.io/datawizard/reference/data_tabulate.html)`(``coffee_data``, `[`c`](https://rdrr.io/r/base/c.html)`(``"treatment"``, ``"time"``)``)`\
...
\
`# Cross table`\
[`data_tabulate`](https://easystats.github.io/datawizard/reference/data_tabulate.html)`(``coffee_data``, ``"treatment"``, by ``=`` ``"time"``)`\
...
`  ``coffee_data``,`\
`  by ``=`` ``"treatment"``,`\
`  select ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``"alertness"``, ``"time"``)``,`\
`  ci ``=`` ``0.95`\
`)`\
...
\
`# model`\
`model`` ``<-`` `[`glm`](https://rdrr.io/r/stats/glm.html)`(``alertness`` ``~`` ``treatment`` ``*`` ``time``, data ``=`` ``coffee_data``, family ``=`` `[`binomial`](https://rdrr.io/r/stats/family.html)`(``)``)`\
\
`# coefficients`\
[`model_parameters`](https://easystats.github.io/parameters/reference/model_parameters.html)`(``model``, exponentiate ``=`` ``TRUE``)`\
...
[`check_model`](https://easystats.github.io/performance/reference/check_model.html)`(``model``)`
...
`predictions`` ``<-`` `[`estimate_means`](https://easystats.github.io/modelbased/reference/estimate_means.html)`(``model``, `[`c`](https://rdrr.io/r/base/c.html)`(``"time"``, ``"treatment"``)``)`\
`predictions`\
...
[`plot`](https://rdrr.io/r/graphics/plot.default.html)`(``predictions``)`
...
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.html)`(``model``, `[`c`](https://rdrr.io/r/base/c.html)`(``"time"``, ``"treatment"``)``)`\
...
[`estimate_contrasts`](https://easystats.github.io/modelbased/reference/estimate_contrasts.html)`(``model``, ``"treatment"``, by ``=`` ``"time"``)`\
`#> Marginal Contrasts Analysis`\
`#> `\
